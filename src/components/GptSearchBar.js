...
const GptSearchBar = () => {
    ...
    return(
        <div className="pt-[45%] md:pt-[15%] lg:pt-[10%] flex justify-center">

            <form className="bg-black w-full md:w-2/3 lg:w-1/2 grid grid-cols-12" onSubmit={(e) => e.preventDefault()}>
