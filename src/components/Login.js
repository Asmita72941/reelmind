...
const Login = () => {
    ...
    return(
        <div className="relative min-h-screen">
            ...
            <form onSubmit={(e) => e.preventDefault()} className="bg-black text-white absolute z-10 w-full md:w-6/12 lg:w-3/12 p-12 my-36 mx-auto left-0 right-0 rounded-lg bg-opacity-80">
                <h1 
